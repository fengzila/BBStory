...
@interface BBDoRecordingController ()

@end

@implementation BBDoRecordingController
...
- (void)loadView
{
    ...
    _bgView = [[UIView alloc] initWithFrame:CGRectMake(0, kDeviceHeight, kDeviceWidth, kDeviceHeight)];
    ...
    _controlLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, kDeviceHeight - 44 - 64 - 42 - 64 - 14, kDeviceWidth, 2)];
    _controlLine.image = [UIImage imageNamed:@"btn_bg"];
    [_bgView addSubview:_controlLine];
    
    _contentWebView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, kDeviceWidth, kDeviceHeight - 44 - 64 - 42 - 64 - 14)];
