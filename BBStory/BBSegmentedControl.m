...
- (void)setDefaults {
    ...
    self.selectionIndicatorMode = BBSelectionIndicatorResizesToStringWidth;
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == BBSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x -  15, self.height - self.selectionIndicatorHeight, stringWidth + 30, self.selectionIndicatorHeight);
    } else {
